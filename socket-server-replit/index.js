...
try {
  ...
  const credential = admin.credential.cert({
    ...
    project_id: process.env.FIREBASE_PROJECT_ID || 'playnowemulator',
  ...
  console.warn('⚠️ Firebase initialization skipped (running in demo mode):', error.message);
}
...
app.get('/stats', (req, res) => {
  const roomStats = Array.from(activeRooms.values()).map(room => ({
    roomId: room.id,
    gameId: room.gameId,
    gameTitle: room.gameTitle,
    gamePlatform: room.gamePlatform,
